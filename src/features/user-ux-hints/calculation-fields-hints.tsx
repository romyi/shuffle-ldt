...
export const SquareInputsHint = createHint(
  ...
  <Stack spacing={"xs"}>
    ...
    <Text size={"xs"}>
      ...
      <strong>
        {" "}
        не учитываются издержки на подключение инфраструктуры к коммуникациям и
        объем годовых затрат на оплату коммунальных услуг.
      </strong>{" "}
      Мы работаем над этим, и вскоре эти параметры также будет учитываться.
